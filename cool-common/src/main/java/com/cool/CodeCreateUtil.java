...
public class CodeCreateUtil {
	...
	//表名称
	private final String tableName = "exec_log";
	//系统名称
	private final String sysName = "task";
	
	private final String changeTableName = replaceUnderLineAndUpperCase(tableName);
	
	private final String smallTableName = StringUtils.lowerCase(changeTableName.substring(0,1)) + changeTableName.substring(1);
    ...
    public Connection getConnection() throws Exception{
        ...
        Connection connection= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/cool?useSSL=false", "root", "15158133802");
        return connection;
    }
    ...
    * @throws
	...
	private List<ColumnClass> getColumnClass(ResultSet resultSet) throws Exception{
        ...
        while(resultSet.next()){
            ...
            if(resultSet.getString("COLUMN_NAME").equals("remark")) continue;
