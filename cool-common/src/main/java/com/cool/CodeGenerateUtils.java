...
* @Description: 代码生成器
* @author panlei
* @date 2017年7月26日 上午10:31:10 
*
 */
public class CodeGenerateUtils {
	private final String AUTHOR = "panlei";
    private final String CURRENT_DATE = "2017/05/03";
    private final String tableName = "sys_user";
    private final String packageName = "com.cool";
    private final String tableAnnotation = "单位";
    private final String URL = "jdbc:mysql://127.0.0.1:3306/cool?useSSL=false";
    private final String USER = "root";
    private final String PASSWORD = "15158133802";
    ...
    private void generateModelFile(ResultSet resultSet) throws Exception{
        ...
        while(resultSet.next()){
            ...
            if(resultSet.getString("COLUMN_NAME").equals("enable")) continue;
            if(resultSet.getString("COLUMN_NAME").equals("create_by")) continue;
            if(resultSet.getString("COLUMN_NAME").equals("create_time")) continue;
            if(resultSet.getString("COLUMN_NAME").equals("update_by")) continue;
            if(resultSet.getString("COLUMN_NAME").equals("update_time")) continue;
        ...
        for(ColumnClass col : columnClassList) {
        		System.out.println(col.getColumnName()+":"+col.getColumnType()+":"+col.getChangeColumnName()+":"+col.getColumnComment());
        }
