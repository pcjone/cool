...
public class BillContent {
	...
	public BillContent(String bill_type, String bill_date) {
		super();
	 ...
	 * 
	* @Title: toJson 
	* @Description: 将BillContent序列化为JSON文本
	* @param @param billContent
	* @param @return     
	* @return String    
	* @throws
	 */
	public String toJson(BillContent billContent) {
		return JSON.toJSONString(billContent);
	}
}
